...
- [arcadia-finance/mcp-server](https://github.com/arcadia-finance/mcp-server) - Manage concentrated liquidity positions with leverage, automated rebalancing, and yield optimization on Base and Optimism.
